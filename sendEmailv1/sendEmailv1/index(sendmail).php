...
try {
    ...
    $mail->Password = 'solaqdovdyzjjhiz'; // SMTP password
    ...
    $mail->addAddress('vqninh1@gmail.com'); // Add a recipient
    ...
    // Mail body content 
    $bodyContent = '<p>Thân gửi Tân sinh viên <b>Vương Quang Ninh</b></h1>'; 
